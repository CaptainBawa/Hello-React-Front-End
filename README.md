...
```sh
  cd my-folder
  git clone git@github.com:CaptainBawa/Hello-React-Front-End.git
```
...
Feel free to check the [issues page](https://github.com/CaptainBawa/Hello-React-Front-End/issues).
...
This project is [MIT](https://github.com/CaptainBawa/Hello-React-Front-End/blob/development/LICENSE) licensed.
